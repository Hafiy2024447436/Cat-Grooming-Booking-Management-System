...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/viewCatCustomer.css?v=button-colors-1" />
</head>
<body>
...
<main class="main">
  ...
  <!-- Back link -->
  <button class="back-link" onclick="window.location.href='${pageContext.request.contextPath}/CatListController'">
