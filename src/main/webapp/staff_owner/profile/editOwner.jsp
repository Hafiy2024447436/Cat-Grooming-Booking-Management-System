...
<c:choose>
        <c:when test="${not empty staff}">
          <div class="view-card">
            <div class="card-title">Edit Owner Account</div>
            <div class="card-subtitle">Update owner information</div>
            ...
            <form id="editOwnerForm" class="edit-form" method="POST" enctype="multipart/form-data"
                  action="${pageContext.request.contextPath}/EditOwnerController" data-disable-validation="true" novalidate>

              <input type="hidden" name="ownerId" value="${staff.staffID}">
...
<button type="button" class="password-eye-btn" onclick="togglePasswordVisibility(this)" aria-label="Show password">
              ...
              <div class="btn-row">
                <button type="button" class="cancel-btn"
                        onclick="window.location.href='${pageContext.request.contextPath}/OwnerController'">
                  Cancel
        ...
        <c:otherwise>
          <div class="view-card">
            <p class="empty">Owner not found.</p>
          </div>
        </c:otherwise>
      </c:choose>
...
setupProfileValidation('editOwnerForm');
