        ...
        <div class="v-hdr">
          <div class="v-avatar">
            <img
              ...
              src="${pageContext.request.contextPath}/StaffPhotoController?id=${staff.staffID}&amp;v=<%= System.currentTimeMillis() %>"
          ...
          <div>
            <div class="v-name">${staff.staffFullName}</div>
            <div class="v-uname">@${staff.staffUsername}</div>
            <div class="vrole-pill ${fn:toLowerCase(staff.staffRole)}">
              ${fn:toUpperCase(fn:substring(staff.staffRole,0,1))}${fn:substring(staff.staffRole,1,fn:length(staff.staffRole))}
            </div>
          </div>
        </div>
        ...
        <div class="info-box">
          <div class="info-grid">
            <div>
              ...
              <div class="iv">${staff.staffFullName}</div>
            </div>
            <div>
              <div class="il">Username</div>
              <div class="iv">@${staff.staffUsername}</div>
            </div>
            <div>
              <div class="il">Email Address</div>
              <div class="iv">${staff.staffEmail}</div>
            </div>
            <div>
              <div class="il">Phone Number</div>
              <div class="iv">${staff.staffPhoneNumber}</div>
            </div>
            <div class="info-full">
              <div class="il">Address</div>
              <div class="iv"><c:out value="${empty staff.staffAddress ? '-' : staff.staffAddress}" /></div>
            </div>
            <div>
              <div class="il">Role</div>
              <div class="iv">${staff.staffRole}</div>
            </div>
          </div>
        </div>
