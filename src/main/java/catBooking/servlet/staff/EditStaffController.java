...
public class EditStaffController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/staff_owner/profile/editStaff.jsp")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String editUrl = request.getContextPath() + "/EditStaffController?id=" + idParam + "&source=" + safeSource;

        try {
            int targetStaffID = Integer.parseInt(idParam);
            boolean canEditPassword = getLoggedInStaffID(request) == targetStaffID;
            ...
            staff.setStaffID(targetStaffID);
            ...
            if (result > 0) {
                response.sendRedirect(redirectTarget + "?notifType=update&notifMsg=Staff%20information%20updated%20successfully.");
            } else {
            ...
            response.sendRedirect(request.getContextPath() +
                "/EditStaffController?id=" + idParam + "&source=" + safeSource + "&error=exception");
        }
    }
}
